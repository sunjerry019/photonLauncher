...
_FILENAME = "dora.bmp" # "fuer_elise_2.bmp"
# done
# 0, 1,3
...
if _MODE == "RUDOLPH":
    ...
    testPic.convert()
    testPic.parseLines()
    testPic.draw(velocity = _velocity, shutterAbsolute = True, shutter_channel = servos.Servo.LEFTCH) if not _ESTIMATEONLY else print(datetime.timedelta(seconds = testPic.estimateTime(velocity = _velocity)))
