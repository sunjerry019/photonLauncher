...
# Uses Tkinter, an apparently very popular and establish library for python gui
# Supposedly references stagecontroller.py for input commands

# copied a template off github for now
