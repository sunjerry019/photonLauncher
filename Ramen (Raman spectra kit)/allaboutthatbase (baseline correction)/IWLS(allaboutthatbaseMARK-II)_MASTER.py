...
parser.add_argument('-niter','--iterations', metavar='niter', type=int, nargs='+', default='50', help='Number of iterations. Adjust this and other parameters to ensure fit converges.')
