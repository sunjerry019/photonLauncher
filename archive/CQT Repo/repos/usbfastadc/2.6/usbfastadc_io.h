/* usbfastadc_io.h: commands to talk to the adc unit. Work in progress.
...
#define _START_QSTREAM        65   /* similar to startstream, but with a
				      different waveform */
...
#define _Set_transferlength   74   /* set transfer length in bytes. Returns
				      adjusted length */
...
#define START_QSTREAM      ( _START_QSTREAM   | IOCBASEWR )
...
#define Set_transferlength   ( _Set_transferlength   | IOCBASEW )
