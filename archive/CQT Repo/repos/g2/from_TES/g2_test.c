...
int main (int argc, char *argv[]) {
    ...
    long long int cnt12, cnt0, cnt1, cnt2,cnt3,cnt4; /* counts in both ends */
   ...
   /* initial reading */
    cnt=0; cnt1=0; cnt2=0; t1=0; cnt12=0; cnt3=0; cnt0=0; cnt4=0;
...
*/
	    ...
	    else if (pattern==pattern2) { /* store in ring */
   ...
   fprintf(stderr,"Counts1: %lld Counts2: %lld Discarded: %lld cnts0: %lld cnts3: %lld cnts4: %lld cnts12: %lld Totalcounts:%lld \n",cnt1,cnt2,discardcnt,cnt0,cnt3,cnt4,cnt12,cnt);
