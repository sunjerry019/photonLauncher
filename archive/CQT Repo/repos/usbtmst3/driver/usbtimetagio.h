...
#define _WriteDelayChip       20   /* write to delay chip. Takes 16bit arg */
#define _SubmitPLLtext        21   /* submits a string to clockchip. takes
				      a complex argument. */
#define _ReadPLLtext          22   /* reads a number of bytes from the
				      clockchip. takes a complex argument. */
...
#define  WriteDelayChip      ( _WriteDelayChip | IOCBASEW )
