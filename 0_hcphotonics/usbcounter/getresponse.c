/* program to talk to serial line with 115200 baud, 8 bits, 1 stop, no parity
   ...
   Sends text to a serial interface (default currently: /dev/ttyUSB0) [Zheng Yang's note: changed to /dev/ttyACM0] 
...
//#define DEFAULTDEVICENAME "/dev/serial/by-id/usb-Centre_for_Quantum_Technologies_USB_Counter_Ucnt-QO07F-if00"
